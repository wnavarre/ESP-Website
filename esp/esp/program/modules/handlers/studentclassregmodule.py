...
class StudentClassRegModule(ProgramModuleObj):
    ...
    def students(self, QObject = False):
        ...
        override_full = Permission.users_with_perm(Program.OVERRIDE_FULL_PERM, program=self.program, QObject=True)
        ...
        if QObject:
            ...
            retVal = {
                ...
                'override_full': ESPUser.objects.filter(override_full).distinct(),
            }
