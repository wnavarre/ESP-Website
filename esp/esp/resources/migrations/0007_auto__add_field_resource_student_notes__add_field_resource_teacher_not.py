...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.student_notes'
        db.add_column('resources_resource', 'student_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Resource.teacher_notes'
        db.add_column('resources_resource', 'teacher_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.student_notes'
        db.delete_column('resources_resource', 'student_notes')

        # Deleting field 'Resource.teacher_notes'
        db.delete_column('resources_resource', 'teacher_notes')
